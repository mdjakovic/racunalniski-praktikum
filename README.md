...
* Odpri terminal (Unix): <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>T</kbd>
* Izbriši eno samo besedo pred kurzorjem v terminlu (Unix): <kbd>Ctrl</kbd>+<kbd>W</kbd>
* Kopiraj označeno v odložišče  (Unix): <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>C</kbd>
* Prilepi vsebino odložišča (Unix): <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>C</kbd>
* "Backtick" (Unix): <kbd>Alt</kbd>+<kbd>7</kbd>
